...
import com.yuanno.block_clover.spells.sealing.sealingprojectile.EvolvedSealingProjectileAbility;
...
public class ModAbilities {
    ...
    public static final AbilityCore[] WATER = new AbilityCore[] {WaterBallAbility.INSTANCE, CurrentOfTheFortuneRiverAbility.INSTANCE, WaterBlessingAbility.INSTANCE, HolyFistOfLoveAbility.INSTANCE, SeaDragonsCradleAbility.INSTANCE, CascadeDestroyerAbility.INSTANCE, SeaDragonsNestAbility.INSTANCE, TaintedCulvertWyrmAbility.INSTANCE, QualleOperationSpell.INSTANCE, SeaSerpentsBelowAbility.INSTANCE, WaterSubstituteSpell.INSTANCE, WaterSoldierAbility.INSTANCE, WaterPressureShotAbility.INSTANCE, WaterSurgeAbility.INSTANCE, WaterShieldAbility.INSTANCE, SeaDragonsRoarAbility.INSTANCE, WaterJavelinAbility.INSTANCE, ValkyrieArmorAbility.INSTANCE, PointBlankDragonAbility.INSTANCE, WaterManaZoneAbility.INSTANCE};
    ...
    public static final AbilityCore[] WIND = new AbilityCore[] {WindBladeAbility.INSTANCE, SlicingWindEmperorAbility.INSTANCE, WindUpAbility.INSTANCE, SlicingWindEmperorWintryWindAbility.INSTANCE, WindCloudAbility.INSTANCE, WhirlwindAbility.INSTANCE, WindCrescentAbility.INSTANCE, WindBladeShowerAbility.INSTANCE, ToweringTornadoAbility.INSTANCE, WindFlightAbility.INSTANCE, TornadoPiercingAbility.INSTANCE, WindGaleAbility.INSTANCE, WindManaZoneAbility.INSTANCE};
    ...
    public static void register(IEventBus eventBus)
    {
        ...
        registerAbilities(EVOLVED_WATER);
