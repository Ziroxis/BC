...
import com.example.block_clover.client.overlay.model.EarthManipulationModel;
...
import com.example.block_clover.spells.earth.EarthManipulationAbility;
...
public class EarthManipulationRenderer<T extends LivingEntity, M extends EntityModel<T>> extends LayerRenderer<T, M> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(Main.MODID + ":textures/entities/layers/spells/earthmanipulation.png");

    private EarthManipulationModel model = new EarthManipulationModel();

    public EarthManipulationRenderer(IEntityRenderer<T, M> entityRenderer)
    {
