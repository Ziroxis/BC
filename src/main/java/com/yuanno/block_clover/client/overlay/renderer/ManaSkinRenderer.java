...
public class ManaSkinRenderer<T extends LivingEntity, M extends EntityModel<T>> extends LayerRenderer<T, M> {

    private ResourceLocation TEXTURE = new ResourceLocation(Main.MODID + ":textures/entities/layers/manaskin/manaskin_");

    private ManaSkinModel model = new ManaSkinModel();

    public ManaSkinRenderer(IEntityRenderer<T, M> entityRenderer)
    {
