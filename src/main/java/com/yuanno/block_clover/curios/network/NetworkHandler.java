...
package com.yuanno.block_clover.curios.network;

import com.yuanno.block_clover.Main;
import com.yuanno.block_clover.api.curios.CuriosApi;
import com.yuanno.block_clover.curios.network.client.*;
import com.yuanno.block_clover.curios.network.server.SPacketBreak;
import com.yuanno.block_clover.curios.network.server.SPacketGrabbedItem;
import com.yuanno.block_clover.curios.network.server.SPacketScroll;
import com.yuanno.block_clover.curios.network.server.SPacketSetIcons;
import com.yuanno.block_clover.curios.network.server.sync.*;
...
public class NetworkHandler {
  ...
  public static void register() {
    ...
    INSTANCE = NetworkRegistry.ChannelBuilder.named(new ResourceLocation(Main.MODID, "curios"))
