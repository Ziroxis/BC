...
public interface ICurioItem {
   ...
   *
   * @param identifier   The {@link com.yuanno.block_clover.api.curios.type.ISlotType} identifier of the slot being
   *                     equipped into
   * @param livingEntity The wearer of the ItemStack
   * @param stack        The ItemStack in question
   ...
   * @return {@link com.yuanno.block_clover.api.curios.type.capability.ICurio.DropRule}
   */
  @Nonnull
