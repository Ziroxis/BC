...
public class LightWeightRingArtifactItem extends ArtifactItem implements ICurioItem {
    ...
    public void curioTick(String identifier, int index, LivingEntity livingEntity, ItemStack stack)
    {
        ...
        if (!livingEntity.getEntity().level.isClientSide && livingEntity.tickCount % 20 == 0 && !livingEntity.isOnGround() && !livingEntity.isInWater())
        {
            livingEntity.addEffect(new EffectInstance(Effects.SLOW_FALLING, 40, -1, true, true));
