...
public class BearClawRenderer<T extends LivingEntity, M extends EntityModel<T>> extends LayerRenderer<T, M> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(Main.MODID + ":textures/entities/layers/spells/bearclaw.png");

    private BearClawModel model = new BearClawModel();

    public BearClawRenderer(IEntityRenderer<T, M> entityRenderer)
    {
