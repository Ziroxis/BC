...
public class GiantLightningOrbParticleEffect extends ParticleEffect {
    ...
    public void spawn(World world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ) {
        for (int i = 0; i < NUM_PARTICLES; i++) {
            ...
            GenericParticleData fireworkParticle = new GenericParticleData(ModParticleTypes.LIGHTNING.get());
