package com.yuanno.block_clover.world.structure.structures;
...
public class UnderWaterDungeonStructure extends Structure<NoFeatureConfig>{

    public UnderWaterDungeonStructure()
    {
    ...
    {
        return UnderWaterDungeonStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart<NoFeatureConfig>
    {
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config)
        {
            int x = chunkX * 16;
            int z = chunkZ * 16;
            BlockPos blockposBaseDungeon = new BlockPos(x, -50, z);

            JigsawManager.addPieces(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            .get(new ResourceLocation(Main.MODID, "underwater_dungeon/start_pool1")),
                            10), AbstractVillagePiece::new, chunkGenerator, templateManagerIn,
                    blockposBaseDungeon, this.pieces, this.random,false,true);
            ...
            LogManager.getLogger().log(Level.DEBUG, "Underwater dungeon at " +
