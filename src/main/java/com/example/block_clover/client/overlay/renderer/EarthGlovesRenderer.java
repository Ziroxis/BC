...
import com.example.block_clover.client.overlay.model.EarthGlovesModel;
...
import com.example.block_clover.spells.earth.EarthGlovesAbility;
...
public class EarthGlovesRenderer<T extends LivingEntity, M extends EntityModel<T>> extends LayerRenderer<T, M> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(Main.MODID + ":textures/entities/layers/spells/earthgloves.png");

    private EarthGlovesModel model = new EarthGlovesModel();

    public EarthGlovesRenderer(IEntityRenderer<T, M> entityRenderer)
    {
