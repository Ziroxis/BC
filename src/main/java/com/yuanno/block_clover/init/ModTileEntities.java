...
public class ModTileEntities {
    ...
    public static final RegistryObject<TileEntityType<QuestBoardTileEntity>> QUEST_TILEENTITY = registerTileEntity("questboard_tile",
            () -> TileEntityType.Builder.of(QuestBoardTileEntity::new, ModBlocks.QUEST_BOARD.get()).build(null));
