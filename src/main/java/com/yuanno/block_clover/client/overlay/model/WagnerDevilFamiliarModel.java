...
public class WagnerDevilFamiliarModel<T extends LivingEntity> extends BipedModel<T> {
	private final ModelRenderer Devil_Familiar;

	public WagnerDevilFamiliarModel() {
		super(RenderType::entityTranslucent, 1, 0.0F, 64, 64);
		texWidth = 32;
		texHeight = 32;

		Devil_Familiar = new ModelRenderer(this);
		Devil_Familiar.setPos(-6.0F, -8.0F, 0.0F);
		Devil_Familiar.texOffs(6, 10).addBox(-2.0F, 2.0F, -1.0F, 1.0F, 3.0F, 2.0F, 0.0F, false);
		Devil_Familiar.texOffs(0, 10).addBox(1.0F, 2.0F, -1.0F, 1.0F, 3.0F, 2.0F, 0.0F, false);
		Devil_Familiar.texOffs(0, 5).addBox(-2.0F, -1.0F, -1.0F, 4.0F, 3.0F, 2.0F, 0.0F, false);
		Devil_Familiar.texOffs(0, 0).addBox(-1.0F, 1.0F, 1.0F, 2.0F, 1.0F, 4.0F, 0.0F, false);
		Devil_Familiar.texOffs(8, 0).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		Devil_Familiar.texOffs(0, 2).addBox(-2.0F, -4.0F, -1.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		Devil_Familiar.texOffs(0, 0).addBox(1.0F, -4.0F, -1.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		Devil_Familiar.texOffs(14, 0).addBox(-1.0F, -2.0F, -2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
		Devil_Familiar.texOffs(12, 9).addBox(-3.0F, -1.0F, -1.0F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Devil_Familiar.texOffs(12, 4).addBox(2.0F, -1.0F, -1.0F, 1.0F, 4.0F, 1.0F, 0.0F, false);
	}
