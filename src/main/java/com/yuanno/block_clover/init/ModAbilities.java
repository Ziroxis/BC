...
public class ModAbilities {
    ...
    public static final AbilityCore[] WIND = new AbilityCore[] {WindBladeAbility.INSTANCE, SlicingWindEmperorAbility.INSTANCE, WindUpAbility.INSTANCE, WindCrescentAbility.INSTANCE, WindBladeShowerAbility.INSTANCE, ToweringTornadoAbility.INSTANCE, WindFlightAbility.INSTANCE, TornadoPiercingAbility.INSTANCE, WindGaleAbility.INSTANCE, WindManaZoneAbility.INSTANCE};
