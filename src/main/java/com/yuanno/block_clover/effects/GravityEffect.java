...
public class GravityEffect extends SpecialEffect{

    public GravityEffect()
    {
        super(EffectType.HARMFUL, Beapi.hexToRGB("#000000").getRGB());
        this.addAttributeModifier(Attributes.MOVEMENT_SPEED, "2727e176-e9e8-4523-92f8-22619308d9ee", -2, AttributeModifier.Operation.ADDITION)
