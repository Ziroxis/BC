...
public class ModAbilities {
    ...
    public static final AbilityCore[] WATER = new AbilityCore[] {WaterBallAbility.INSTANCE, CurrentOfTheFortuneRiverAbility.INSTANCE, WaterBlessingAbility.INSTANCE, HolyFistOfLoveAbility.INSTANCE, SeaDragonsCradleAbility.INSTANCE, CascadeDestroyerAbility.INSTANCE, SeaDragonsNestAbility.INSTANCE, TaintedCulvertWyrmAbility.INSTANCE, QualleOperationSpell.INSTANCE, SeaSerpentsBelowAbility.INSTANCE, WaterSubstituteSpell.INSTANCE, WaterSoldierAbility.INSTANCE, WaterShieldAbility.INSTANCE, SeaDragonsRoarAbility.INSTANCE, WaterJavelinAbility.INSTANCE, ValkyrieArmorAbility.INSTANCE, PointBlankDragonAbility.INSTANCE, WaterManaZoneAbility.INSTANCE};
