...
public class HeavyInfightingAbility extends ContinuousAbility {
    ...
    public static final AbilityCore INSTANCE = new AbilityCore.Builder("Heavy infighting", AbilityCategories.AbilityCategory.DEVIL, HeavyInfightingAbility.class)
            .setDescription("Lowers the weight of your punches, giving attack speed.\nAugmenting the weight of your punches when hitting something, giving damage")
