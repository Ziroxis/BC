...
public class DarkIceBallSpellGoal extends CooldownGoal {
    private BCentity entity;

    public DarkIceBallSpellGoal(BCentity entity)
    {
        super(entity);
        this.entity = entity;
    ...
    public void start()
    {
        ...
        DarkIceBallProjectile projectile = new DarkIceBallProjectile(this.entity.level, this.entity);
