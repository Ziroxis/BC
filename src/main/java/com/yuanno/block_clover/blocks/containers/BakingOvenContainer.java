...
public class BakingOvenContainer extends Container {
    ...
    public BakingOvenContainer(int windowID, World world, BlockPos pos, PlayerInventory inventory, PlayerEntity player ) {
        ...
        if(tileEntity != null) {
            tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h -> {
                ...
                addSlot(new SlotItemHandler(h,4,108,35));
                addSlot(new SlotItemHandler(h,5,108,35));
                addSlot(new SlotItemHandler(h,6,108,35));
