...
public class CompleteRenderer<T extends LivingEntity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(Main.MODID + ":textures/entities/layers/complete.png");

    private CheckModel model = new CheckModel();

    public CompleteRenderer(IEntityRenderer<T, M> entityRenderer)
    {
