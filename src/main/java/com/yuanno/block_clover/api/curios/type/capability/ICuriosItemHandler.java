...
package com.yuanno.block_clover.api.curios.type.capability;
...
public interface ICuriosItemHandler {
  ...
  /**
   * A map of the current curios, keyed by the {@link com.yuanno.block_clover.api.curios.type.ISlotType} identifier.
   *
  ...
  /**
   * Gets the number of slots across all {@link com.yuanno.block_clover.api.curios.type.ISlotType} identifiers.
   *
   ...
   *
   * @return A set of {@link com.yuanno.block_clover.api.curios.type.ISlotType} identifiers
   */
  ...
  /**
   * Gets the Optional {@link ICurioStacksHandler} associated with the given {@link com.yuanno.block_clover.api.curios.type.ISlotType}
   * identifier or Optional.empty() if it doesn't exist.
   *
   * @param identifier The identifier for the {@link com.yuanno.block_clover.api.curios.type.ISlotType}
   * @return The stack handler
   */
  Optional<ICurioStacksHandler> getStacksHandler(String identifier);

  /**
   * Enables the {@link com.yuanno.block_clover.api.curios.type.ISlotType} for a given identifier, adding the default settings to the curio
   * map.
   *
   * @param identifier The identifier for the {@link com.yuanno.block_clover.api.curios.type.ISlotType}
  ...
  /**
   * Disables the {@link com.yuanno.block_clover.api.curios.type.ISlotType} for a given identifier, removing it from the curio map.
   *
   * @param identifier The identifier for the {@link com.yuanno.block_clover.api.curios.type.ISlotType}
   */
   ...
   * when overriding { ICurio#getAttributeModifiers(SlotContext, UUID)}
   * <p>
   * Removes an amount of slots from the { ICurioStacksHandler} of a {@link com.yuanno.block_clover.api.curios.type.ISlotType}
