...
public class ModAbilities {
    ...
    public static final AbilityCore[] WATER = new AbilityCore[] {WaterBallAbility.INSTANCE, CurrentOfTheFortuneRiverAbility.INSTANCE, WaterBlessingAbility.INSTANCE, HolyFistOfLoveAbility.INSTANCE, SeaDragonsNestAbility.INSTANCE, CascadeDestroyerAbility.INSTANCE, WaterShieldAbility.INSTANCE, SeaDragonsRoarAbility.INSTANCE, WaterJavelinAbility.INSTANCE, ValkyrieArmorAbility.INSTANCE, PointBlankDragonAbility.INSTANCE, WaterManaZoneAbility.INSTANCE};
