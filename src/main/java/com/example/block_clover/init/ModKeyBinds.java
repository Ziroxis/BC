...
import com.example.block_clover.networking.client.CChangeCombatBarPacket;
import com.example.block_clover.networking.client.COpenPlayerScreenPacket;
import com.example.block_clover.networking.client.CToggleCombatModePacket;
import com.example.block_clover.networking.client.CUseAbilityPacket;
...
public class ModKeyBinds {
    ...
    public static void init()
    {
        ...
        combatSlot2 = new KeyBinding("Keys.block_clover.combat_2", GLFW.GLFW_KEY_2, "Keys.block_clover.combat");
        ClientRegistry.registerKeyBinding(combatSlot2);
        combatSlot3 = new KeyBinding("Keys.block_clover.combat_3", GLFW.GLFW_KEY_3, "Keys.block_clover.combat");
        ClientRegistry.registerKeyBinding(combatSlot3);
        combatSlot4 = new KeyBinding("Keys.block_clover.combat_4", GLFW.GLFW_KEY_4, "Keys.block_clover.combat");
        ClientRegistry.registerKeyBinding(combatSlot4);
        combatSlot5 = new KeyBinding("Keys.block_clover.combat_5", GLFW.GLFW_KEY_5, "Keys.block_clover.combat");
        ClientRegistry.registerKeyBinding(combatSlot5);
        combatSlot6 = new KeyBinding("Keys.block_clover.combat_6", GLFW.GLFW_KEY_6, "Keys.block_clover.combat");
        ClientRegistry.registerKeyBinding(combatSlot6);
        combatSlot7 = new KeyBinding("Keys.block_clover.combat_7", GLFW.GLFW_KEY_7, "Keys.block_clover.combat");
        ClientRegistry.registerKeyBinding(combatSlot7);
        combatSlot8 = new KeyBinding("Keys.block_clover.combat_8", GLFW.GLFW_KEY_8, "Keys.block_clover.combat");
