...
public class ModAbilities {
    ...
    public static final AbilityCore[] DEVIL = new AbilityCore[] {CrowAbility.INSTANCE, DarkFireBallAbility.INSTANCE, DarkIceAbility.INSTANCE, DevilSummoning.INSTANCE};
