package com.yuanno.block_clover.particles.fire;
...
public class FireBallParticleEffect extends ParticleEffect {
    ...
    public void spawn(World world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ) {
        for (int i = 0; i < numParticles; i++) {
            ...
            GenericParticleData flameParticle = new GenericParticleData(ModParticleTypes.FIRE.get());
            flameParticle.setLife(10);
            flameParticle.setSize(0.5f);
            flameParticle.setMotion(0, 0.01, 0);
            Beapi.spawnParticles(flameParticle, (ServerWorld) world, particlePosX + offsetX, particlePosY + offsetY, particlePosZ + offsetZ);
        }
    }
}
