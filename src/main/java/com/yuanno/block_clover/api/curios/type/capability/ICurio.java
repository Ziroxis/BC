...
public interface ICurio {
   ...
   *
   * @param identifier   The {@link com.yuanno.block_clover.api.curios.type.ISlotType} identifier of the ItemStack's slot
   ...
   *
   * @param identifier   The {@link com.yuanno.block_clover.api.curios.type.ISlotType} identifier of the slot being equipped into
   * @param livingEntity The wearer of the ItemStack
   ...
   *
   * @param identifier   The {@link com.yuanno.block_clover.api.curios.type.ISlotType} identifier of the slot being unequipped from
   * @param livingEntity The wearer of the ItemStack
   ...
   *
   * @param identifier   The identifier of the {@link com.yuanno.block_clover.api.curios.type.ISlotType} of the slot
   * @param index        The index of the slot
