...
public class VolcanoDungeonStructure extends Structure<NoFeatureConfig> {

    public VolcanoDungeonStructure()
    {
    ...
    {
        return VolcanoDungeonStructure.Start::new;
    }
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config)
        {
            ...
            JigsawManager.addPieces(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            .get(new ResourceLocation(Main.MODID, "fire_dungeon/start_pool1")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Fire dungeon at " +
