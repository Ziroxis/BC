...
public class ValkyrieArmorParticleEffect extends ParticleEffect {
    ...
    public void spawn(World world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ) {
        for (int i = 0; i < NUM_PARTICLES; i++) {
            ...
            waterParticle.setLife(40);
            waterParticle.setSize(SIZE);
            waterParticle.setMotion(motionX, motionY, motionZ);

            Beapi.spawnParticles(waterParticle, (ServerWorld) world, particlePosX, particlePosY, particlePosZ);
        }
    }
